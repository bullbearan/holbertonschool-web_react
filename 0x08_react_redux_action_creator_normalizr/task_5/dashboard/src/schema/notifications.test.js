...
describe("0x08 project - task 0", function () {
	it("0x08 project - task 0", function () {
	...
	describe("0x08 project - task 1", function () {
		it("0x08 project - task 1", function () {
			const expectedResult = [
		...
		it("0x08 project - task 1", function () {
			...
			expect(notification).toEqual(expectedResult);
		});
	});
});
